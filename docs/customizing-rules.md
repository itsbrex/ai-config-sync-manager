  ...
  "templates": [
    {
      ...
      "aliases": {
        "claude": ["Task tool", "Task-tool delegation", "Claude subagent delegation", "gstack 위임"],
        "codex": ["spawn_agent", "sub-agent delegation", "Codex worker/explorer delegation", "gstack worker"]
      },
      "target": {
